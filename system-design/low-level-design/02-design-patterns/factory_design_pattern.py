...
# p1 = IPerson()
# p1.person_method() ## gives error can't instanciate
...
class Teacher(IPerson):
    ...
    def __init__(self):
        self.name ="Bharath Roxzer"

    def person_method(self):
        print("Iam a teacher")

# s1= Student()
# s1.person_method() # this will work and prints results

# t1 = Teacher()
# t1.person_method() # this will work and prints results
...
if __name__ == "__main__":
    person = PersonFactory.get_person("student")
    person.person_method()
    person = PersonFactory.get_person("teacher")
    person.person_method()



## anotjer examples
# 1. audio and video exporst based on quality -> low,medium and high ,its code
